...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   A modified version of the IEEE 30 bus network with a quadratic objective used in,
%
...
%
function mpc = nesta_case30_kds__rad
mpc.version = '2';
mpc.baseMVA = 100.0;
...
mpc.gencost = [
	2	 0.0	 0.0	 3	   0.038432	  20.000000	   0.000000; % NG
	2	 0.0	 0.0	 3	   0.250000	  20.000000	   0.000000; % NG
	2	 0.0	 0.0	 3	   0.010000	  40.000000	   0.000000; % SYNC
	2	 0.0	 0.0	 3	   0.010000	  40.000000	   0.000000; % SYNC
	2	 0.0	 0.0	 3	   0.010000	  40.000000	   0.000000; % SYNC
	2	 0.0	 0.0	 3	   0.010000	  40.000000	   0.000000; % SYNC
];
